...
. *提交 sdkconfig.defaults*
+
包含合理的默认值，便于团队协作

. *不提交 sdkconfig*
+
已添加到 .gitignore，避免配置冲突
...
* https://docs.espressif.com/projects/esp-idf/en/v5.3/api-guides/kconfig.html[ESP-IDF 配置系统]
* https://docs.espressif.com/projects/esp-idf/en/v5.3/api-guides/kconfig.html#kconfig-syntax[Kconfig 语法]
* link:architecture.adoc[HeteroLink 架构]
